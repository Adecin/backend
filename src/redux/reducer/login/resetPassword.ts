...
const ResetPassword: any = createSlice({
    name: "ResetPassword",
    initialState: {
        isLoading: false,
        isSuccess: false,
    ...
    extraReducers: (builder: any) => {
        builder.addCase(resetPassword.pending, (state: any, { payload }: any) => {
            state.isLoading = true;
        });
        builder.addCase(resetPassword.fulfilled, (state: any, { payload }: any) => {
        ...
        builder.addCase(resetPassword.rejected, (state: any, { payload }: any) => {
            state.isLoading = false;
